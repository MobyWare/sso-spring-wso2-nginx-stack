...
(TENANT_ID, INBOUND_AUTH_KEY, INBOUND_AUTH_TYPE, INBOUND_CONFIG_TYPE, PROP_NAME, PROP_VALUE, APP_ID) VALUES (-1234,'7r3TkShn_GkoAXdtdW0CeVgB69Ya','oauth2','standardAPP',NULL,NULL,2),(-1234,'wso2-test-api-federated','passivests','standardAPP',NULL,NULL,2),(-1234,'wso2-test-api-federated','openid','standardAPP',NULL,NULL,@app_id);
